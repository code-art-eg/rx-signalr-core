...
declare module 'karma-server-side' {
  export function run<T>(fn: (this: KarmaServerSideContext) => Promise<T> | T): Promise<T>;
  export function run(fn: (this: KarmaServerSideContext) => void): Promise<void>;
  export function run<T, U>(arg1: T, fn: (this: KarmaServerSideContext, a: T) => Promise<U> | U): Promise<U>;
